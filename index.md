...
Try [`gym-pybullet-drones`](https://github.com/JacopoPan/gym-pybullet-drones), a physics engine-based quadcopter control simulation for multi-agent reinforcement learning
